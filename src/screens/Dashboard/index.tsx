...
export function Dashboard(){
	...
	async function loadTransactions(){
		...
		const totalInterval = lastTransactionExpensives === 0 && lastTransactionEntries === 0
			? ''
		...
		setHighlightData({
			...
			expensives: {
				...
				lastTransaction: lastTransactionExpensives === 0? '' : `Última saída dia ${lastTransactionExpensives}`,
			},
			total: {
		...
		// console.log("highlightData.total.amount: ",highlightData.total.amount);
